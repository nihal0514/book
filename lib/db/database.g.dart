    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Book` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` TEXT NOT NULL, `cover` TEXT NOT NULL, `author` TEXT NOT NULL, `publishedYear` TEXT NOT NULL, `readStatus` INTEGER NOT NULL)');
